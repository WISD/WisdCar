...
namespace Zeta.WisdCar.Repository.CRUD
{
    ...
    internal partial class KVLookup
	{
		...
		public int Add(WisdCar.Model.PO.KVLookupPO model)
		{
			...
			strSql.Append("LookupKey,LookupValue,CategoryNo,LogicalStatus,CreatorID,CreatedDate,LastModifierID,LastModifiedDate,Reserved1,Reserved2,Reserved3)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@CategoryNo", SqlDbType.Char,18),
			...
			parameters[2].Value = model.CategoryNo;
		...
		public bool Update(WisdCar.Model.PO.KVLookupPO model)
		{
			...
			strSql.Append("CategoryNo=@CategoryNo,");
		...
		public WisdCar.Model.PO.KVLookupPO GetModel(int LookupID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 LookupID,LookupKey,LookupValue,CategoryNo,LogicalStatus,CreatorID,CreatedDate,LastModifierID,LastModifiedDate,Reserved1,Reserved2,Reserved3 from KVLookup ");
			strSql.Append(" where LookupID=@LookupID");
			SqlParameter[] parameters = {
					new SqlParameter("@LookupID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select LookupID,LookupKey,LookupValue,CategoryNo,LogicalStatus,CreatorID,CreatedDate,LastModifierID,LastModifiedDate,Reserved1,Reserved2,Reserved3 ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" LookupID,LookupKey,LookupValue,CategoryNo,LogicalStatus,CreatorID,CreatedDate,LastModifierID,LastModifiedDate,Reserved1,Reserved2,Reserved3 ");
			strSql.Append(" FROM KVLookup ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
