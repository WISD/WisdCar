...
namespace Zeta.WisdCar.Repository.CRUD
{
	...
	internal partial class ClubCardPackage
	{
		...
		public int Add(WisdCar.Model.PO.ClubCardPackagePO model)
		{
			...
			strSql.Append("PackageName,OriginalAmount,ActualAmount,DiscountRate,DiscountInfo,PackageStatus,Salesman,SalesTime,SaleStore,PackageID,LogicalStatus,CreatorID,CreatedDate,LastModifierID,LastModifiedDate,Reserved1,Reserved2,Reserved3)");
			...
			parameters[10].Value = model.LogicalStatus;
			parameters[11].Value = model.CreatorID;
			parameters[12].Value = model.CreatedDate;
			parameters[13].Value = model.LastModifierID;
			parameters[14].Value = model.LastModifiedDate;
			parameters[15].Value = model.Reserved1;
			parameters[16].Value = model.Reserved2;
			parameters[17].Value = model.Reserved3;
		...
		public bool Update(WisdCar.Model.PO.ClubCardPackagePO model)
		{
			...
			parameters[16].Value = model.Reserved2;
			parameters[17].Value = model.Reserved3;
			parameters[18].Value = model.ClubCardPackageID;
		...
		public WisdCar.Model.PO.ClubCardPackagePO GetModel(int ClubCardPackageID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ClubCardPackageID,PackageName,OriginalAmount,ActualAmount,DiscountRate,DiscountInfo,PackageStatus,Salesman,SalesTime,SaleStore,PackageID,LogicalStatus,CreatorID,CreatedDate,LastModifierID,LastModifiedDate,Reserved1,Reserved2,Reserved3 from ClubCardPackage ");
			strSql.Append(" where ClubCardPackageID=@ClubCardPackageID");
			SqlParameter[] parameters = {
					new SqlParameter("@ClubCardPackageID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ClubCardPackageID,PackageName,OriginalAmount,ActualAmount,DiscountRate,DiscountInfo,PackageStatus,Salesman,SalesTime,SaleStore,PackageID,LogicalStatus,CreatorID,CreatedDate,LastModifierID,LastModifiedDate,Reserved1,Reserved2,Reserved3 ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ClubCardPackageID,PackageName,OriginalAmount,ActualAmount,DiscountRate,DiscountInfo,PackageStatus,Salesman,SalesTime,SaleStore,PackageID,LogicalStatus,CreatorID,CreatedDate,LastModifierID,LastModifiedDate,Reserved1,Reserved2,Reserved3 ");
			strSql.Append(" FROM ClubCardPackage ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
