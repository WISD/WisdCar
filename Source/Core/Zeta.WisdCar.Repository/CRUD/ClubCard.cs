...
namespace Zeta.WisdCar.Repository.CRUD
{
	...
	internal partial class ClubCard
	{
		...
		public int Add(WisdCar.Model.PO.ClubCardPO model)
		{
			...
			strSql.Append("ClubCardTypeName,CustName,ClubCardType,ClubCardPwd,OpenCardStore,SalesMan,SalesTime,Balance,CustomerID,ClubCardTypeID,ExpireDate,CardStatus,ClubCardNo,LogicalStatus,CreatorID,CreatedDate,LastModifierID,LastModifiedDate,Reserved1,Reserved2,Reserved3)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@ClubCardType", SqlDbType.NVarChar,50),
			...
			parameters[2].Value = model.ClubCardType;
			parameters[3].Value = model.ClubCardPwd;
			parameters[4].Value = model.OpenCardStore;
			parameters[5].Value = model.SalesMan;
			parameters[6].Value = model.SalesTime;
			parameters[7].Value = model.Balance;
			parameters[8].Value = model.CustomerID;
			parameters[9].Value = model.ClubCardTypeID;
			parameters[10].Value = model.ExpireDate;
			parameters[11].Value = model.CardStatus;
			parameters[12].Value = model.ClubCardNo;
		...
		public bool Update(WisdCar.Model.PO.ClubCardPO model)
		{
			...
			strSql.Append("ClubCardType=@ClubCardType,");
			...
			parameters[19].Value = model.Reserved2;
			parameters[20].Value = model.Reserved3;
			parameters[21].Value = model.ClubCardID;
		...
		public WisdCar.Model.PO.ClubCardPO GetModel(int ClubCardID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ClubCardID,ClubCardTypeName,CustName,ClubCardType,ClubCardPwd,OpenCardStore,SalesMan,SalesTime,Balance,CustomerID,ClubCardTypeID,ExpireDate,CardStatus,ClubCardNo,LogicalStatus,CreatorID,CreatedDate,LastModifierID,LastModifiedDate,Reserved1,Reserved2,Reserved3 from ClubCard ");
			strSql.Append(" where ClubCardID=@ClubCardID");
			SqlParameter[] parameters = {
					new SqlParameter("@ClubCardID", SqlDbType.Int,4)
			};
		...
		public WisdCar.Model.PO.ClubCardPO DataRowToModel(DataRow row)
		{
			...
			if (row != null)
			{
				...
				if(row["ClubCardType"]!=null)
				{
					model.ClubCardType=row["ClubCardType"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ClubCardID,ClubCardTypeName,CustName,ClubCardType,ClubCardPwd,OpenCardStore,SalesMan,SalesTime,Balance,CustomerID,ClubCardTypeID,ExpireDate,CardStatus,ClubCardNo,LogicalStatus,CreatorID,CreatedDate,LastModifierID,LastModifiedDate,Reserved1,Reserved2,Reserved3 ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ClubCardID,ClubCardTypeName,CustName,ClubCardType,ClubCardPwd,OpenCardStore,SalesMan,SalesTime,Balance,CustomerID,ClubCardTypeID,ExpireDate,CardStatus,ClubCardNo,LogicalStatus,CreatorID,CreatedDate,LastModifierID,LastModifiedDate,Reserved1,Reserved2,Reserved3 ");
			strSql.Append(" FROM ClubCard ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
